export const ENEMIES = [
  ...
  },
  {
    ...
    recipeDrops: [{ recipeId: 'toxicMist', chance: 8 }],
  ...
  },
  {
    ...
    abilities: [], weakness: 'wind',
    statusResist: { freeze: 40 },
    recipeDrops: [{ recipeId: 'galeStorm', chance: 6 }],
  ...
  },
  {
    ...
    abilities: ['numb'], weakness: 'fire',
    recipeDrops: [{ recipeId: 'chainBolt', chance: 8 }],
  ...
  },
  {
    ...
    abilities: [], weakness: 'fire',
    statusResist: { paralysis: 40, freeze: 40 },
  ...
  },
  {
    ...
    abilities: [], weakness: 'wind',
    packLeader: true, leaderBuff: { speedPct: 0, dmgPct: 10 },
    kmDrops: [{ blueprintId: 'bpSwordStorm', chance: 35 }, { blueprintId: 'bpFlameGale', chance: 25 }],
    recipeDrops: [{ recipeId: 'swordArc', chance: 60 }, { recipeId: 'piercingEdge', chance: 35 }],
  ...
  },
  {
    ...
    abilities: [], weakness: 'fire',
    statusResist: { paralysis: 30, freeze: 30 },
    packLeader: true, leaderBuff: { speedPct: 10, dmgPct: 5 },
    kmDrops: [{ blueprintId: 'bpIronHowl', chance: 40 }],
    recipeDrops: [{ recipeId: 'flameWave', chance: 60 }],
  ...
  // ---- Elite bosses (ancient horrors; lairs in world.js BOSS_SPAWNS) ----
  {
    ...
    statusResist: { paralysis: 60, freeze: 60, burn: 50 },
  ...
  },
  {
    ...
    statusResist: { paralysis: 60, freeze: 100, burn: 60, poison: 50 },
  ...
  },
  {
    ...
    statusResist: { paralysis: 60, freeze: 60, poison: 100 },
