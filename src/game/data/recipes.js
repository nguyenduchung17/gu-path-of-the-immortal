...
export const RECIPES = [
  ...
  { id: 'flameSerpent', guId: 'flameSerpent', path: 'fire', masteryReq: 2, stageReq: 3, materials: { fireEssence: 5, beastCore: 2 }, essence: 25, stones: 60, hint: 'Carried by the serpents of the Mist Forest.' },
  ...
  { id: 'windStep', guId: 'windStep', path: 'wind', masteryReq: 1, stageReq: 1, materials: { spiritGrass: 3 }, essence: 12, stones: 25, hint: 'Sold by Old Merchant Chen in Green Valley.' },
  ...
  { id: 'tideBinding', guId: 'tideBinding', path: 'water', masteryReq: 2, stageReq: 3, materials: { moonPetal: 2, shadowSilk: 2 }, essence: 20, stones: 60, hint: 'Hidden in a cave off the forest trail.' },
